...
import ArchiveNavigation from './Components/ArchiveNavigation.vue'

const props = defineProps({
  topic: Object,
  entry: Object,
  relatedEntries: { type: Array, default: () => [] },
  archiveNavigation: { type: Object, default: () => ({ topics: [] }) },
})
</script>
  ...
  <HorizonContainer class="py-8 md:py-10">
    <article class="mx-auto max-w-7xl space-y-8">
      ...
      <div class="grid gap-6 lg:grid-cols-[18rem_minmax(0,1fr)] lg:items-start">
        <ArchiveNavigation :navigation="archiveNavigation" :active-topic-slug="topic.slug" :active-entry-slug="entry.slug" />
