...
<template>
  <article
    class="hz-surface-welcome group rounded-[1.75rem] border transition duration-200 hover:-translate-y-0.5 hover:border-white/[0.12] hover:shadow-[0_10px_28px_rgb(0_0_0/0.22)]"
