...
const organizationTreasuryLogoSrc = '/images/PNG_Symbolly_logo.png'
...
function inventoryTransferApproveHref(id) {
  if (isOrganizationLedger.value) {
    return route('organization.ledger.inventory.transfer.approve', id)
  }
...
function inventoryTransferRejectHref(id) {
  if (isOrganizationLedger.value) {
    return route('organization.ledger.inventory.transfer.reject', id)
  }
        ...
        <div class="relative grid gap-6 lg:grid-cols-[minmax(0,1fr)_20rem] lg:items-end">
          <div>
            ...
            <div class="mt-2 flex items-center gap-4">
              <div
                v-if="isOrganizationLedger"
                class="flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/[0.042] p-2 md:h-16 md:w-16"
              >
                <img
                  :src="organizationTreasuryLogoSrc"
                  alt="Horizon Treasury symbol"
