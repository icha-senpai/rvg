...
class LedgerService
{
    ...
    {
        return $this->transfers->approvePendingFundTransferForOrganization($actor, $transferRequest);
    }
    ...
    {
        return $this->transfers->rejectPendingFundTransferForOrganization($actor, $transferRequest, $data);
    }
