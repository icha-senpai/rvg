...
class OperationPresenter
{
    ...
    public function summary(): array
    {
        return [
            ...
            'after_action_signed_off_early_user_ids' => $this->operation->after_action_signed_off_early_user_ids ?? [],
            'after_action_excused_user_ids' => $this->operation->after_action_excused_user_ids ?? [],
