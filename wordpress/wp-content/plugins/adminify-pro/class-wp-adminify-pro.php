...
class Adminify_Pro
{
    ...
    public static function adminify_pro_activation_hook(){
		$plugin_option = get_option('_wpadminify');
		$plugin_option['white_label']['adminify']['plugin_option'] = true;
		update_option('_wpadminify', $plugin_option);
    }
