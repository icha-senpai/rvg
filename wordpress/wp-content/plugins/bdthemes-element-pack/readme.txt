...
= 8.3.0 [4th August 2025] =

= Added =

* Shape Divider extension added
* Aura style added in creative button widget
* Always Visible Tooltip feature added to the marker widget
* Wave styles added in notation extension
* Post author role added in dynamic content
* Added & updated controls under the Image, Button, and Badge sections in the WC Products widget
* Button width control added in price table widget
* Text alignment option added in call out widget

= Fixed =

* Excerpt condition issue fixed in the wc products widget
* Image Masking extension editor controls fixed
* Open Street Map widget security issue fixed
* Marquee rotation & auto gap issue fixed
* Hove state issue fixed in Advanced Icon Box widget
* Editor mode edit template issue fixed

= Updated =

* Image Masking updated with VISUAL CHOICE control

= 8.2.1 [21st July 2025] =

= Added =

* Widget compatibility added in sticky extension
* Image & text controls dynamic tags compatibility added
* Confirmation message style controls added in gravity forms widget

= Fixed =

* Rollback forward issue fixed
* Default image not showing issue fixed in animated card widget
* Table body border radius issue fixed in Table widget
* Submit button disabled issue fixed in User Register widget
* Breadcrumbs separator style issue fixed
* Sticky extension issue fixed
* Slinky vertical menu sticky offset error fixed
* Nested item Open/Close icon issue fixed for Accordion widget ( Thanks to David Stauble )

= 8.2.0 [13th July 2025] =

= Added =

* Rollbck Version feature added

= Updated =

* Security Improved
* Multisite license system improved — available exclusively for Agency and Developer plans

= 8.1.3 [13th July 2025] =

= Added =

* Delay Hide option added for Megamenu widget ( Thanks to Bill )

= Fixed =

* License deactivation issue fixed for invalid license ( Thanks to Chris Jones )

= 8.1.2 [8th July 2025] =

= Added =

* Hash Location control added in Table of Content widget (depends on Click History setting)

= Fixed =

* Hash location issue fixed in Tabs widget
* Post info widget category fixed

= Updated =

* Multisite license system updated
* Multisite license page UI improved
* Security Improved
...
* Container/section support added in cursor effects extension

= Fixed =

* Remote widgets insert both elements in the same section and container issue fixed
* Content overflow issue fixed in fancy tabs widget (Thanks to Oscar)
* Background Parallax extension issue fixed

= 8.1.0 [30th June 2025] =

= Added =

* Added WPML compatibility for URL field type
* Added Border Radius control to the Slideshow widget
* Integrated Border Radius control into the global widget control file

= Fixed =

* Security issue fixed
* Security issue mitigated in our vendor UIKit JS until an official fix is released. (Thanks to Cristian Bejan)
* Builder post default edit issue fixed ( Thanks to Next Reach )
* Submit button align issue fixed in forminator forms widget
