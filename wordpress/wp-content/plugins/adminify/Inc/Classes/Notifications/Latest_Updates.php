		...
		public function notice_content()
		{
			if("dismissed" !== get_option('_wpadminify_plugin_update_info_notice', true )){
				$jltwp_adminify_changelog_message = sprintf(
					...
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list">Fixed the Admin bar link was unresponsive.</span><br>', 'adminify'),
					__('<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Fixed the Admin menu was unresponsive while no title. </span><br>', 'adminify'),
